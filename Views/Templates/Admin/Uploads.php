    ...
    <div class="border border-blue-500 border-dashed rounded-xl mt-10 py-10 px-5 flex justify-center items-center flex-col cursor-pointer" id="uploadContainer">
        <i class="material-icons-outlined text-blue-500 text-xl md:text-8xl">cloud_upload</i>
        ...
        <table class="text-white w-full">
            <thead class="mb-5 opacity-80">
                <tr class="text-left">
                    ...
                    <th scope="col" class="font-light text-sm px-3 py-2">Size</th>
            ...
            <tbody>
                <tr class="mt-5">
                    ...
                    <td scope="row" class="px-5 py-4 font-semibold">20KB</td>
