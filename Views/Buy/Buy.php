...
<?php headerLanding($data); ?>
    ...
    <main class="min-h-screen mt-[100px] px-5 md:px-20 lg:px-32">
        ...
        <div id="default-styled-tab-content">
            <div class="animate__animated animate__fadeIn hidden" id="styled-profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="grid md:grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10">
                    <div class="bg-white rounded-xl p-5 md:p-10 h-auto">
                        ...
                        <div class="flex flex-wrap md:flex-nowrap border-b border-gray-100 mt-5 justify-center">
                            <input type="number" class="outline-0 text-black font-bold inline-block text-right w-48 pb-3 text-xl md:text-6xl realtime-input" value="1000">
                    ...
                    <div class="bg-white rounded-xl p-5 md:p-10 flex flex-col justify-between">
                        <div>
                            ...
                            <button type="button" class="mt-3 rounded-full text-black flex justify-center p-4 text-center border w-full text-sm border-dashed font-semibold add-new-card">
            ...
            <div class="animate__animated animate__fadeIn hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="styled-dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="text-2xl capitalize">sell</div>
            </div>
